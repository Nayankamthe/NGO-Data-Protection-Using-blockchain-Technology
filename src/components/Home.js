    ...
    <div className="row">
      ...
      <div className="social-links">
        <ul>
          ...
          <li><a href="https://www.linkedin.com/in/nayan-kamthe-70931b197" target="_blank"><i className="fa fa-linkedin" /></a></li>
          <li><a href="boffins@gmail.com" target="_blank"><i className="fa fa-mail-reply" /></a></li>
        </ul>
      </div>
    </div>
  </header> {/* /header */}
      ...
      <div className="main-content-tablecell">
        <div className="row">
          <div className="col-twelve">
            <br /> <br /> <br /> <br /> <br /> <br />
            &lt;<br /><br/><br /><br /><br /><br /><br /><br /> <h1 align="right">TRANSACTION MADE SECURE</h1><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
           </div>
           <div className="col-thirteen"> <h1 align="center">
          ...
          <div id="tab-contact" className="tab-content">
            <div className="tab-entry">
              <div className="row tab-entry-intro">
                <div className="col-twelve with-bottom-line">
                  <h1>Get In Touch.</h1>
                  <p className="lead" href="mailto:rajbipin1412@gmail.com" target="_top">Please email the founder to show your support</p>
                  <p />
                  <p className="lead" href="mailto:rajbipin1412@gmail.com">contact@ngoxchange.com</p>
                </div>
              </div> {/* /tab-content-intro */}
      ...
      <ul className="tabs" style ={{marginRight: "50px"}}>
          <li className="active" data-id="tab-about"><i className="icon-blank" /><span>The Team</span></li>
                      ...
                      <div className="bgrid item" style={{marginLeft:"275px"}}>
                        <span className="icon"><img src="images/shailesh.png" height={250} width={250} alt="" /></span>
                        <div className="item-content">
                          <h3 className="h05">Project Guide <br /><a href target="_blank">Prof. Sailesh Kurzadkar</a></h3>
                          <p ><br />
                          </p>
                        </div>
                      </div> {/* /bgrid */}
                ...
                <div  style={{marginLeft:"350px" }}>
                  <div className="about-list block-1-3 block-s-1-2 block-tab-full">
                    <div className="bgrid item">
                      <span className="icon"><img src="images/nayan.png" height={225} width={225} alt="" /></span>
                      <div className="item-content">
                        <h3 className="h05">Group Leader <br /><a href="https://www.linkedin.com/in/nayan-kamthe-70931b197" target="_blank">Mr. Nayan Kamthe</a></h3>
                        <p align="left">
                          <br />
                          <br />
                        </p>
                    ...
                    <div className="bgrid item">
                      <span className="icon"><img src="images/pranita.png" height={225} width={225} alt="" /></span>
                      <div className="item-content">
                        <h3 className="h05">Group Member <br /><a href="https://www.linkedin.com/in/pranita-ambade-a13279190" target="_blank">Miss. Pranita P. Ambade</a></h3>
                        <p align="left">
                          <br />
                          <br />
                          <br />
                    ...
                    <div className="bgrid item">
                      <span className="icon"><img src="images/ravina.png" height={200} width={200} alt="" /></span>
                      <div className="item-content">
                        <h3 className="h05">Group Member <br /><a href="https://www.linkedin.com/in/dharminsinh-pankajsinh-rathod-b31070141/" target="_blank">Miss. Ravina M. Bute </a></h3>
                        <p align="left">
                          <br />
                          <br />
                        </p>
                    ...
                    <div className="bgrid item">
                      <span className="icon"><img src="images/kanchan.png" height={200} width={200} alt="" /></span>
                      <div className="item-content">
                        <h3 className="h05">Group Member <br /><a href="https://www.linkedin.com/in/yash-vashi-39422219b/" target="_blank">Miss. Kanchan Bawane</a> </h3>
                        <p align="left">
                          <br />
                        </p>
                      </div>
  ...
  <footer>
    <div className="social-wrap">
      <div className="row">
        <ul className="footer-social-list" style={{marginLeft:"500px"}}>
          ...
          <li><a href="mailto:boffins.com" target="_blank">
    ...
    <div className="footer-bottom">
      ...
      <div className="copyright">
        <span>Contact: nkamthe85@gmail.com</span><br />
      </div>
    </div> {/* /footer-bottom */}
  </footer>
</div>
